...
data <- read.csv("input/clean data/data_lsg.csv",stringsAsFactors = F)
...
write.csv(results_table,"output/Results tables/agg_data_RS_15_04.csv", row.names = F)
